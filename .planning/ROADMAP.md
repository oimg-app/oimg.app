...
- [x] 06-01-PLAN.md — Wave 1: snippets.ts builders + OutputPanel (INSP-07) — 3 copy-snippet sections + empty state
- [x] 06-02-PLAN.md — Wave 1: ReportPanel (INSP-08) — Total savings stats + per-file bar chart + Format breakdown
