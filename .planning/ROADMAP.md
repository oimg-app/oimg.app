...
- [ ] **Phase 1: Foundation** — Tailwind + design tokens + AppShell skeleton + stub data + format utils
...
- [ ] 01-05-PLAN.md — AppShell walking skeleton (SHELL-01): src/App.tsx + AppShell + 3 skeleton panes + human verify
**UI hint**: yes
